...
```bash
npm install -g https://www.myfundfarm.com/cli/fundfarm-cli-0.2.5.tgz
fundfarm login
fundfarm whoami
```
...
| `fundfarm trade buy <代码> --amount <金额> --time <交易时间> --yes` | 买入基金 |
| `fundfarm trade sell <代码> --shares <份额> --time <交易时间> --yes` | 卖出基金 |
